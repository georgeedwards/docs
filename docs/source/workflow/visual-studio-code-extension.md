...
![Installing NativeScript extension for Visual Studio Code](../docs/img/visual-studio-code-extension/configurations-menu.png)
...
![NativeScript Debugging](../docs/img/visual-studio-code-extension/nativescript-debugging.png)
...
![Supply custom arguments to the debug command](../docs/img/visual-studio-code-extension/nativescript-tns-args.png)
...
![NativeScript commands](../docs/img/visual-studio-code-extension/nativescript-commands.png)
...
![NativeScript not found](../docs/img/visual-studio-code-extension/nativescript-not-found-error-message.png)
